...
describe("The Coreweaver Method", () => {
  it("explains the decision path, keeps Earthward Foundry clearly exploratory, and links to live content silos", () => {
    ...
    expect(screen.getByRole("link", { name: /video guide/i }).getAttribute("href")).toBe("#video-answer-guide");
    ...
    expect(screen.getByRole("heading", { name: /ask how the planned video connects to the method/i })).toBeTruthy();
    expect(screen.getByText(/browser-local, deterministic guide/i)).toBeTruthy();
