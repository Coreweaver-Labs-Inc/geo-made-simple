...
export const faqCategories: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { question: "What are the approved service starting prices?", answer: <>Coreweaver Labs’ approved commercial starting prices are <strong>from $6,500/month for SEO</strong>, <strong>from $7,500/month for Content Marketing</strong>, and <strong>from $7,500/month for Paid Ads</strong>. These are starting prices, not a guaranteed scope; the documented statement of work confirms the final scope, timing, and any separate costs such as paid-media spend.</>, schemaAnswer: "Coreweaver Labs’ approved commercial starting prices are from $6,500 per month for SEO, from $7,500 per month for Content Marketing, and from $7,500 per month for Paid Ads. A statement of work confirms final scope, timing, and separate costs such as paid-media spend." },
