  ...
  return (
    <MarketingShell>
      ...
      <main>
        ...
        <section className="insights-substack section-pad section-rule"><div><SectionLabel>Longer-form research</SectionLabel><h2>Follow the signal beyond the index.</h2><p>See how Coreweaver Labs reviews sources, authorship, claims, and corrections before publishing research—or choose a connected B2B growth topic before reading extended notes and working ideas on Substack.</p></div><div className="insights-actions"><a className="button button-secondary" href="/topics">B2B Growth Topics <ArrowUpRight size={16} aria-hidden="true" /></a><a className="button button-secondary" href="/research">Research methods <ArrowUpRight size={16} aria-hidden="true" /></a><a className="button button-primary" href="https://coreweaverlabs.substack.com/" target="_blank" rel="noopener noreferrer">Read on Substack <ArrowUpRight size={16} aria-hidden="true" /></a></div></section>
      </main>
    </MarketingShell>
  );
}
