...
export default function ChildTopicDetail() {
  ...
  return <MarketingShell><SeoHead title={`${topic.title} | Coreweaver Labs`} description={topic.description} path={path} /><main className="topic-detail-page child-topic-detail-page"><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: schema }} />
