...
export default function Methodology() {
  return <MarketingShell>
    ...
    <main className="method-page">
      ...
      <section className="method-thesis section-pad">
      ...
      <section className="method-chapters section-pad" aria-label="Method chapters">
      ...
      <section className="method-entity section-pad">
      ...
      <section className="method-silos section-pad">
      ...
      <section className="method-foundry section-pad">
