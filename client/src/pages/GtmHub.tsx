...
const services: Array<{ code: string; id: Exclude<ServiceInterest, "not_sure">; title: string; price: string; note: string; text: string; includes: string[] }> = [
  {
    ...
    id: "seo",
    title: "SEO",
    price: "Research estimate: from $6,500/month",
    note: "Exact scope and pricing confirmed before engagement",
  ...
  },
  {
    ...
    price: "Research estimate: from $7,500/month",
    note: "Exact scope and pricing confirmed before engagement",
  ...
  },
  {
    ...
    title: "Paid Ads",
    price: "Research estimate: from $7,500/month",
    note: "Media spend is separate; exact scope and pricing confirmed before engagement",
