...
export default function GtmHub() {
  ...
  return <MarketingShell><SeoHead title="SEO, Content Marketing & Paid Ads for Mid-Market B2B | Coreweaver Labs" description="Evidence-led SEO, Content Marketing, and Paid Ads services for mid-market B2B teams, with transparent starting prices and a private support path." path="/services" /><main>
    ...
    <section className="gtm-first-engagement section-pad section-rule" aria-labelledby="first-engagement-title"><div className="gtm-first-engagement-intro"><SectionLabel>First engagement record</SectionLabel><h2 id="first-engagement-title">Begin with a shared record, not a vague scope.</h2><p>A first engagement is a careful orientation. It gives both teams a way to inspect the current information, name the decision in front of them, and agree what deserves focused work. It does not guarantee a result or obligate either team to a broader engagement.</p></div><ol className="gtm-first-engagement-steps"><li><span>01</span><div><h3>Orientation</h3><p>Clarify the team, commercial context, current question, and the information that is appropriate to review.</p></div></li><li><span>02</span><div><h3>Evidence inventory</h3><p>Review available public information and any selected material a team chooses to share, while keeping private context private.</p></div></li><li><span>03</span><div><h3>Decision map</h3><p>Identify the clearest working problem, the relevant source and ownership questions, and the smallest useful next decision.</p></div></li><li><span>04</span><div><h3>Reviewed working plan</h3><p>Confirm whether there is a fit to proceed, with exact scope, responsibilities, review method, and commercial terms agreed separately.</p></div></li></ol><p className="gtm-first-engagement-boundary">This record describes an approach to orientation. It is not a delivery timeline, statement of work, or promise of rankings, leads, revenue, or return on ad spend.</p></section>
