  ...
  return (
    <footer className="site-footer section-pad">
      ...
      <div className="footer-navigation">
        <div className="footer-links">{navItems.map(item => <a key={item.href} href={item.href}>{item.label}</a>)}<a href="/#resources">Resources</a><a href="/products">Products</a><a href="/contact">Contact</a><a href="/ai-data-policy">AI Data Policy</a></div>
