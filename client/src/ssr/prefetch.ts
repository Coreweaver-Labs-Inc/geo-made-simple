...
export async function prefetchForPath(url: string, queryClient: QueryClient, prefetch: SsrPrefetch): Promise<HeadMeta> {
  ...
  if (clean === "/services") return { title: "GTM Services and Support | Coreweaver Labs", description: "Explore Coreweaver Labs' integrated GTM services, customer support path, and evidence-led operating foundation.", canonicalPath: clean };
