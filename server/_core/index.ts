...
async function startServer() {
  ...
  app.get("/sitemap.xml", async (_req, res) => {
    ...
    const fixedPaths = ["/", "/framework", "/products", "/services", "/topics", "/topics/b2b-seo", "/topics/b2b-seo/website-information-architecture", "/topics/b2b-content-marketing", "/topics/b2b-content-marketing/buyer-enablement", "/topics/b2b-content-marketing/content-refresh", "/topics/b2b-paid-ads", "/topics/b2b-paid-ads/message-landing-page-alignment", "/topics/ai-representation", "/topics/ai-representation/ai-answer-review", "/topics/content-governance", "/topics/content-governance/claim-ledger", "/insights", "/research", "/method", "/faq", "/ai-data-policy", "/case-studies", "/contact", "/authors/mason-nguyen"];
