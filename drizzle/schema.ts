...
export const insights = mysqlTable("insights", {
  ...
  contentType: mysqlEnum("contentType", ["article", "research_brief", "field_brief"]).default("article").notNull(),
  sourceReferences: text("sourceReferences"),
  methodNote: text("methodNote"),
  claimReviewer: varchar("claimReviewer", { length: 220 }),
...
export const gtmOpportunities = mysqlTable("gtm_opportunities", {
  ...
  serviceLine: mysqlEnum("serviceLine", ["signal_intelligence_audit", "gtm_enablement_sprint", "representation_operations", "seo", "content_marketing", "paid_ads", "custom"]).notNull(),
  title: varchar("title", { length: 220 }).notNull(),
